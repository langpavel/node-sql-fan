## Contributing to SQL Fan

♥ [SQL Fan](https://github.com/langpavel/node-sql-fan) and want to get involved? Thanks!
...
The [issue tracker](https://github.com/langpavel/node-sql-fan/issues) is the preferred channel
for [bug reports](#bugs), [features requests](#features) and [submitting pull requests](#pull-requests),
but please respect the following restrictions:

* Please **do not** use the issue tracker for personal support requests.
  [Gitter](https://gitter.im/sql-fan) is better place to get help.
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure
   ...
   git clone https://github.com/<your-username>/node-sql-fan.git
   # Navigate to the newly cloned directory
   cd node-sql-fan
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/langpavel/node-sql-fan.git
   ```
